...
def generate_dataset(J_array, P_array, w_array, executer: NetworkExecuterWithSimplifiedFF, heter_ff=None):
...
if __name__ == "__main__":
    ...
    for _ in range(restart_num):
        y_E, y_I = generate_dataset(J_config, P_config, w_config, executer, heter_ff_config)  # regenerate data every iterations
