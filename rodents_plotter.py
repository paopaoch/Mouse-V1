...
if __name__ == "__main__":
    ...
    if not_data:
        ...
        if responses_path == "":
            ...
            J_array = [-18.3442, -33.8304, -13.3833, -31.2847]
            P_array = [-2.7423999999999995, 12.193299999999995, -2.6773000000000002, 10.729900000000008]
            w_array = [-160.0568, -146.1833, -105.03369999999997, -131.5775]
