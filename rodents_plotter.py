...
if __name__ == "__main__":
    ...
    if not_data:
        ...
        if responses_path == "":
            ...
            # J_array = [-0.6388630000000002, 1.8723540000000003, -1.391042, 0.794095]
            # P_array = [-2.720267, 0.9054599999999998, -0.421757, 1.5112260000000002]
            # w_array = [0.9786219999999998, -0.962887, 0.6903929999999999, 0.41400699999999985] 
