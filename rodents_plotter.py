...
if __name__ == "__main__":
    ...
    if not_data:
        ...
        if responses_path == "":
            ...
            # J_array = [0.23704799999999987, 0.15423299999999987, 0.10297699999999994, -0.25521199999999983]
            ...
            # J_array = [-0.8518973337185339, 1.923237300239142, -0.8831280002763748, 2.7064470592837595]
            # P_array = [-3.3621358598173647, 1.5429971478193836, 2.7444651478439894, 2.5311953570646906]
            # w_array = [-1.9175402540019593, -3.4521248290260798, -1.2235600455813467, 0.5091667081975852] 

            # J_array = [-0.8073, 2.397600000000001, -0.2703, 2.3745000000000007]
            # P_array = [-2.8618, 1.3553000000000004, -3.4474, 0.45609999999999995]
            # w_array = [-3.5758, -2.2744999999999997, -1.5745, -0.4125] 

            J_array = [-3.3097, -2.6342, -0.4808,  0.3865]
            P_array = [-4.2426, -0.3900, -2.4065,  2.7040]
            w_array = [-0.0832, -1.4192,  1.9023,  0.1874]
