...
if __name__ == "__main__":
    ...
    if not_data:
        ...
        if responses_path == "":
            ...
            J_array = [-5.1454, -19.987500000000004, 2.0304000000000006, -14.735]
            P_array = [-1.9717, 5.993300000000001, -2.4430000000000005, 6.0013999999999985]
            w_array = [-116.74240000000002, -131.939, -131.57530000000003, -131.87929999999997]
