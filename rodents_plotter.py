...
if __name__ == "__main__":
    ...
    if not_data:
        ...
        if responses_path == "":
            ...
            J_array = [0.019703000000000356, -19.593, 0.7355200000000005, -19.214000000000002]
            P_array = [-2.6569999999999996, 6.6101, -3.3149999999999995, 5.514600000000001]
            w_array = [-201.3, -139.0, -125.34999999999997, -129.98999999999998]
