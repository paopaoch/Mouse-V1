...
for i in range(200):
    ...
    if i > 20 and torch.tensor(losses[-10:], device=device).mean() < 1e-6: # This is the same stopping criterion as xNES which could be appropriate but the learning rate is different.
