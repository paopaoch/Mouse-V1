...
if __name__ == "__main__":
    ...
    if SEARCH_INIT:
        ...
        if INITIAL:
            ...
            mean_list = [-19.4847, -34.1360, -12.9933, -32.0393, -2.3561, 10.8197, -2.8583, 10.8158, -132.2900, -133.9398, -126.9572, -134.3532]  # Backwards
            mean_list = [ -18.3442, -33.8304, -13.3833, -31.2847, -2.7424, 12.1933, -2.6773, 10.7299, -160.0568, -146.1833, -105.0337, -131.5775]  # xNES
            mean_list = [-19.4856, -34.1301, -12.9694, -32.0478, -2.3555, 10.8198, -2.8454, 10.8159, -132.286, -133.9427, -126.9548, -134.3574,]  # forwards
            
            mean_list = [-5, -18, 2, -15, 
                 -2, 6, -2, 6, 
                 -135, -132, -131, -132]  # deviation from Config 13 10000
            
            mean_list = [-6.5124, -18.3093, 1.9300, -15.0095, -2.5466,  5.1354, -2.6696, 4.7931, -146.3552, -141.0944, -150.1857, -124.6875]  # xNES 10000
            mean_list = [-5.1454, -19.9875, 2.0304, -14.735, -1.9717, 5.9933, -2.443, 6.0014, -116.7424, -131.939, -131.5753, -131.8793]  # forwards 10000

            mean_list = [-6.5166, -18.3074, 1.9317, -15.0115, -2.548, 5.1356, -2.6689, 4.793, -146.3562, -141.0875, -150.1646, -124.7009]  # forwards after xNES
            mean_list = [-6.5146,
                -18.3078,
                1.9324,
                -15.0128,
